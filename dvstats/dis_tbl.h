...
/* Integer numbering of PowerPC opcodes.  Note that there are 368
...
/* This used to be with the other SVC's, but since we don't expect
   to see it, we moved it here to make room for OP_ADD_IMM in
   the first 256.
*/
#define OP_SVCLA			286

#define NUM_BASIC_PPC_OPCODES		287
...
/* Synonyms between Power and PowerPC */
#define OP_DCBZ			       OP_DCLZ
#define OP_TLBIE		       OP_TLBI
